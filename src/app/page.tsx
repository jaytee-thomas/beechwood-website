         ...
         <motion.div
          ...
          >
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              <motion.div
                variants={fadeInUp}
                className="bg-gradient-to-br from-beechwood-blue to-beechwood-navy p-8 rounded-2xl border border-white/10 hover:border-beechwood-red/50 transition-all duration-300 hover:scale-105"
              >
          ...
          >
            ...
            <div className="bg-gradient-to-br from-blue-900/30 via-beechwood-blue to-beechwood-navy p-12 rounded-2xl border border-blue-500/30 hover:border-blue-400/50 transition-all duration-300">
